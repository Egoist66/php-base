...
class Pagination
{
    ...
    final public function get_mid_size(): int
    {
    ...
    final public function get_count_pages(): int
    {
        return ceil($this->total / $this->per_page) ?: 1;
    }

    final public function get_current_page(): int
    {
        if ($this->page < 1) {
            $this->page = 1;
        }
    ...
    final public function get_params(): string
    {
    ...
    final public function get_link(int $page): string
    {
        if ($page === 1) {
